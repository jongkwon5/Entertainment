          ...
          <ul id="signup_top">
            <div id="signup_box1">
              <li>
                ...
                <button type="button" id="main_bt" onclick="openIdChk()">
             		     중복확인
                </button>
              </li>
            </div>
            <li><input type="password" placeholder="비밀번호" id="password_name"
                name="password"/></li>
            <li><input type="password" placeholder="비밀번호재확인" id="password_name2"
                name="password2"/></li>
            <li><input type="text" placeholder="이름" id="name_singup"
                name="name"/></li>
            <div id="signup_box2">
              <li>
            ...
            <div id="signup_box3">
              <li>
                <input type="number" placeholder="전화번호" id="phone_name"
                name="phone"/>
                <button id="main_bt"
                >
                 		인증번호발송
            ...
            <li>
              <label><input type="checkbox" id="checkbox" />개인정보 제공동의</label>
              <div id="hint"></div>
            </li>
            <li>
              <button id="signup_button"  type="submit" onclick="login_check();return false"><span>가입하기</span></button>
            </li>
          </ul>
        </form>
      </div>
