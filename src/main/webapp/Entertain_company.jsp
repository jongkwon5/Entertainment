...
<link rel="stylesheet" type="text/css" href="${context}/resources/css/stylesheet_company.css" />
...
<div class="footer">
	...
	<ul class="footer_box">
		<li class="footer_menu" >
			<a href="Entertain_main.do">
				<p>HOME</p>
			</a>
		</li>
		<li class="footer_menu" >
			<a href="Entertain_company.do">
				<p>COMPANY</p>
			</a>
		</li>
		<li class="footer_menu" >
			<a href="Entertain_artist.do">
				<p>ARTIST</p>
			</a>
		</li>
		<li class="footer_menu" >
			<a href="Entertain_audition.do">
				<p>AUDITION</p>
			</a>
		</li>
		<li class="footer_menu" >
			<a href="Entertain_board_list.do">
				<p>BOARD</p>
			</a>
		</li>
	</ul>
