                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach items="${boardList}" var="board" varStatus="loop">
                            <tr scope="row" class="boardList"
                                onclick="window.location.href='getOneBoard?board_number=${board.Board_Number}'"
                                style="cursor: pointer;">
                                <td>${board.Board_Number}</td>
                                <td>${board.Board_User_Id}</td>
                                <td>${board.Board_Title}[${board.comment_count}]</td>
                                <td><fmt:formatDate value="${board.Board_Create_Date}"
                                                    pattern="YY년 MM월 dd일 a HH시 mm분"/></td>
