    ...
    <div class="main">
        ...
        <div class="main_wrap">
            ...
            <div class="mv_section active">
                <i class="up_1 fa-solid fa-angles-up fa-flip"
                   style="--fa-animation-duration: 1.5s; cursor: pointer"></i>
                <div class="img_ive img"></div>
                <video src="${context}/resources/Image/Home/mv_ive.mp4" preload="auto" autoplay="autoplay" loop="loop"
            ...
            <div class="mv_section active2">
                ...
                <video src="${context}/resources/Image/Home/mv_lessar.mp4" preload="auto" autoplay="autoplay"
            ...
            <div class="mv_section active3">
                ...
                <video src="resources/Image/Home/mv_nmixx.mp4" preload="auto" autoplay="autoplay" loop="loop"
                       muted="muted" volume="0"></video>
