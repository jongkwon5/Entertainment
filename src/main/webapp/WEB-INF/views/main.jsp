	...
	<div class="main">
		...
		<!--************************** slide 1 ***********************-->
			<div class="mv_section active">
            	...
            	<video src="${context}/resources/Image/Home/mv_ive.mp4" preload="auto" autoplay="autoplay" loop="loop" muted="muted" volume="0"></video>
		...
		<!--************************** slide 2 ***********************-->
			<div class="mv_section active2">
            	...
            	<video src="${context}/resources/Image/Home/mv_lessar.mp4" preload="auto" autoplay="autoplay" loop="loop" muted="muted" volume="0"></video>
