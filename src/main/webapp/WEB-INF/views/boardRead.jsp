            ...
            <div id="board_top">
                ...
                <div id="board_button">
                    ...
                    <c:if test="${board.board_user_id eq user.user_id}">
                        ...
                        <button type="button" id="updateBT"
                                onclick="location.href='getBoardUpdate?board_number=${board.board_number}'">글수정
                        </button>
                    </c:if>
                </div>
            </div>
                        ...
                        <c:forEach items="${comment}" var="comment">
                            <tr>
                                ...
                                <c:if test="${comment.comment_user_id eq user.user_id}">
                                    <td style="width: 70px;">
                                        <button id="commentUpdate_${comment.comment_number}"
                                                onclick="updateComment(${comment.comment_number})">수정하기
                                        </button>
                                    </td>
                                    <td style="width: 70px;">
                                        <button id="commentDelete_${comment.comment_number}"
                                                onclick="deleteComment(${comment.comment_number})">삭제하기
                                        </button>
                                    </td>
                                </c:if>
                            </tr>
