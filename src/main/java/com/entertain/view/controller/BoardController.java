...
public class BoardController {
	...
	/*
	 * @RequestMapping(value = "/getBoardSearch", method = RequestMethod.GET) public
	 * String getSearchList(Model model, BoardVO vo, @RequestParam("searchType")
	 * String searchType,
	 * 
	 * @RequestParam("searchInput") String searchInput) {
	 * vo.setSearch_type(searchType); vo.setBoard_text(searchInput);
	 * model.addAttribute("boardList", boardService.getSearchList(vo)); return
	 * "boardList"; }
	 */
}
